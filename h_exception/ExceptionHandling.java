...
public class ExceptionHandling {
	...
	public static void main(String[] args) {
		...
		} catch (ArithmeticException | IndexOutOfBoundsException e) { // 타입을 여러개 추가
			e.printStackTrace();
		} catch (NullPointerException e) { // catch 여러개 사용

		} catch (Exception e) { // 모든 예외처리를 한번에 (Exception을 파라미터로 넣음)
