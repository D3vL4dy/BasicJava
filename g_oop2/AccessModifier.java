...
public class AccessModifier {
	...
	String defaultVar = "default : 같은 패키지에서만 접근 가능"; //접근제한자 형식 없음 (생략됨)
	...
	public static void main(String[] args) {
		AccessModifier am = new AccessModifier(); //main에 static이 붙어서 객체 생성 후 사용
...
//		t.hour = 14; //변수를 통해 접근하면 이상한 값 출력됨
//		t.minute = 9;
//		t.second = 99; 
		t.setHour(16);
		t.setMinute(9);
